...
function Message_other({ usermessage, message, sender, time }: any) {
  ...
  return (
    <div className="w-full flex gap-[5px]  items-baseline  pl-[15px] z-0">
...
function Own_Message({ message, user }: any) {
  return (
    <div className="w-full flex gap-[5px]   justify-end pr-[15px] items-baseline z-0">
 ...
 useEffect(() => {
  ...
  return (
    <div className="justify-between flex-col gap-[10px] w-full h-full">
      <div
        className=" flex flex-col gap-[10px] overflow-y-scroll z-0 h-[91%] "
        ref={chatContainer}
      >
        {messages.length != 0 &&
