...
export default function Search({ channels, users }: Props) {
    ...
    return (<>
        <div onClick={onOpen} className='ml-[5px] w-[90%]  md:h-[65px] h-[40px] mt-5 border-2 border-black rounded-sm flex justify-between items-center custom-shadow cursor-pointer'>
